...
**IMPORTANT:** As of 8 May 2026, American Truck Simulator and Euro Truck Simulator 2 have been updated to version 1.59. Some mods have been fixed, but others should have minimal (if any) issues with the new version, but if you have any issues with them, please let me know!
{{</callout>}}


### American Truck Simulator

A full list of ATS mods can be found [here](ats).
...
Tested with ATS version 1.46 (**minimum version**) and works without issues with version 1.59.
